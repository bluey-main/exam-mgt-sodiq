...
const TETHnd1: React.FC = () => {
  ...
  const [finalDataHnd1, setfinalDataHnd1] = useState<{ data: DayData[] }>({
      ...
      <Tabs defaultValue="day1" className="w-full">
        <TabsList className="flex gap-x-3">
          {numberOfDays.map((day, index) => (
            <TabsTrigger value={day} key={index} className={`flex-1 ${(finalDataHnd1.data[index].active == true) ? "bg-green-500": "bg-red-500" }`}>
              Day {index + 1}
            </TabsTrigger>
          ))}
        </TabsList>
              ...
              <Card className="w-[30rem] border-black">
                ...
                <div className="flex justify-between">
                    ...
                    <CardTitle className="text-2xl">
                      {finalDataHnd1.data[index].course}
                    </CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
                  <div className="flex flex-col gap-y-6">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setfinalDataHnd1((prevData) => ({
                          data: prevData.data.map((dayData, dataIndex) => ({
                            ...dayData,
                            date:
                              dataIndex === index
                    ...
                    <div>
                      ...
                      <p>Selected option: {finalDataHnd1.data[index].time}</p>
                    </div>
                  </div>
                </CardContent>
